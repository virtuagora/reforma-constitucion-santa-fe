...
;(function ($, window, document) {
	...
	var _templates = {
		...
		youtube:	'<iframe width="560" height="315" src="//www.youtube.com/embed/{id}" frameborder="0" allowfullscreen></iframe>'
	};
			...
			$.each(groups, function(idx, group) {
				...
				$.each(group.split(','), function(idx, button) {
					...
					$button = _tmpl('toolbarButton', {
							name: button,
							icon: base._(base.commands[button].icon || 'fa-dot-circle-o'),
...
// TODO: Make configurable
	...
	$.sceditor.defaultOptions = {
		...
		toolbar:'bold,italic,underline,strike,subscript,superscript|left,center,right,justify|' +
				'font,size,color,removeformat|bulletlist,orderedlist|table,horizontalrule|' +
				'image,youtube,link,unlink|maximize,source',
